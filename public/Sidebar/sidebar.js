var upperDiv = document.getElementById("fffs");
...
<div class="custom_field">   
  <input class="slider_ar" type="range" min="0" max="450" value="0" step ="10" id="width">
   ...
   <p class="h_ar">Page Themes:</p>
    <div class="BLtoggle" id="doBeeLine">
     </div>


        
    <p style="margin-top: 44%;" class="h_ar" onclick="rtdefault()" data-color="off"><a style="margin-left: 0 !important; padding: 0; margin-bottom:0px;">Reset all settings</a></p> 
...
<div id="custom_sidebar" class="custom_sidebar">
  <div class="top-bar" style="">
        ...
        <div class="top-bar-unit">
            <h5 id="open_sidebar3" class="">Resources</h5>
        </div>
...
$(".elm-header-global-nav").css("display", "none");
...
$("#ta").change(function(){
  ...
  var ta = $(this).children("option:selected").val();
  $('section.mt-content-container *').css("text-align", ta);
  $('section.mt-content-container p').css("text-align", ta);
...
if (window.beelineEnabled) {
				...
				bL.innerHTML += `<a class="btn btn-large" data-color="dark">Bright</a>`;
				bL.innerHTML += `<a class="btn btn-large" data-color="blues">Blues</a>`;
				bL.innerHTML += `<a class="btn btn-large" data-color="gray">Grays</a>`;
