...
if(!window["THREEloaded"]) {
	...
	(function () {
		...
		if (!window.requestAnimationFrame) window.requestAnimationFrame = function (b) {
			var c = Date.now(), f = Math.max(0, 16 - (c - a)), h = window.setTimeout(function () {
				b(c + f)
			}, f);
			a = c + f;
			return h
	...
	THREE.Color.prototype = {
		constructor: THREE.Color, r: 1, g: 1, b: 1, copy: function (a) {
			...
			var d, e, f;
			if (c === 0) this.r = this.g = this.b = 0; else {
				d = Math.floor(a * 6);
				e = a * 6 - d;
				a = c * (1 - b);
				f = c * (1 - b * e);
	...
	THREE.Vector3.prototype = {
		...
		setLength: function (a) {
			...
			var c = b ? b.x : 1, d = b ? b.y : 1, e = b ? b.z : 1, f = a.elements[0] / c, h = a.elements[4] / d,
				c = a.elements[1] / c, d = a.elements[5] / d, i = a.elements[9] / e, l = a.elements[10] / e;
	...
	THREE.Frustum.prototype.setFromMatrix = function (a) {
		...
		b = d[1];
		var e = d[2], f = d[3], h = d[4], i = d[5], l = d[6], k = d[7], j = d[8], m = d[9], n = d[10], o = d[11],
			s = d[12],
			p = d[13], q = d[14], d = d[15];
	...
	THREE.Ray = function (a, b) {
		...
		var f = new THREE.Vector3, h = new THREE.Vector3, i = new THREE.Vector3, l = new THREE.Vector3,
			k = new THREE.Vector3, j = new THREE.Vector3, m = new THREE.Vector3, n = new THREE.Vector3,
			o = new THREE.Vector3;
		this.intersectObject = function (a) {
			...
			if (a instanceof THREE.Particle) {
				...
				var q, u, y = a.geometry, w = y.vertices, A;
				...
				for (g = y.faces.length; p < g; p++) {
					...
					if (!(Math.abs(q) < e)) {
						u = n.dot(m) / q;
						if (!(u < 0) && (a.doubleSided || (a.flipSided ?
							q > 0 : q < 0))) {
							...
							if (b instanceof THREE.Face3) {
								...
								if (d(o, f, h, i)) {
									b = {distance: k.distanceTo(o), point: o.clone(), face: b, object: a};
									s.push(b)
								}
								...
								if (d(o, f, h, l) || d(o, h, i, l)) {
									b = {
										distance: k.distanceTo(o), point: o.clone(),
										face: b, object: a
									};
									s.push(b)
								}
		...
		var s = new THREE.Vector3, p = new THREE.Vector3, q = new THREE.Vector3, w, A, y, u, H, B, K, N, Y, ca, I
	};
	...
	THREE.Matrix3.prototype = {
		constructor: THREE.Matrix3, getInverse: function (a) {
			var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9],
				d = b[6] * b[1] - b[2] * b[5], e = -b[10] * b[4] + b[6] * b[8], f = b[10] * b[0] - b[2] * b[8],
				h = -b[6] * b[0] + b[2] * b[4], i = b[9] * b[4] - b[5] * b[8], l = -b[9] * b[0] + b[1] * b[8],
				k = b[5] * b[0] - b[1] * b[4], b = b[0] * a + b[1] * e + b[2] * i;
			b === 0 && console.warn("Matrix3.getInverse(): determinant == 0");
			var b = 1 / b, j = this.elements;
			j[0] = b * a;
			j[1] = b * c;
			j[2] = b * d;
			j[3] = b * e;
	...
	THREE.Matrix4.prototype = {
		constructor: THREE.Matrix4, set: function (a, b, c, d, e, f, h, i, l, k, j, m, n, o, s, p) {
			var q = this.elements;
			q[0] = a;
			q[4] = b;
			q[8] = c;
			...
			var d = this.elements,
				e = THREE.Matrix4.__v1, f = THREE.Matrix4.__v2, h = THREE.Matrix4.__v3;
			h.sub(a, b).normalize();
			if (h.length() === 0) h.z = 1;
			...
			var c = a.elements, d = b.elements, e = this.elements, f = c[0], h = c[4], i = c[8], l = c[12], k = c[1],
				j = c[5], m = c[9], n = c[13], o = c[2], s = c[6], p = c[10], q = c[14], w = c[3], A = c[7], y = c[11],
				c = c[15], u = d[0], H = d[4],
				B = d[8], K = d[12], N = d[1], Y = d[5], ca = d[9], I = d[13], ba = d[2], ja = d[6], ya = d[10],
				D = d[14],
				g = d[3], Na = d[7], za = d[11], d = d[15];
			...
			var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], h = a[5], i = a[9], l = a[13],
				k = a[2], j = a[6], m = a[10], n = a[14], o = a[3], s = a[7],
				p = a[11], a = a[15];
			...
			var b = this.elements, c = a.elements, d = c[0], e = c[4], f = c[8], h = c[12], i = c[1], l = c[5],
				k = c[9],
				j = c[13], m = c[2], n = c[6], o = c[10], s =
					c[14], p = c[3], q = c[7], w = c[11], c = c[15];
			...
			var c = this.elements, d = a.x, e = a.y, f = a.z, h = Math.cos(d), d = Math.sin(d), i = Math.cos(e),
				e = Math.sin(e), l = Math.cos(f), f = Math.sin(f);
			switch (b) {
				case "YXZ":
					var k = i * l, j = i * f, m = e * l, n = e * f;
					c[0] = k + n * d;
					c[4] = m * d - j;
					c[8] = h * e;
					c[1] = h * f;
			...
			var b = this.elements, c = a.x, d = a.y, e = a.z, f = a.w, h = c + c, i = d + d, l = e + e, a = c * h,
				k = c * i, c = c * l, j = d * i, d = d * l, e = e * l, h = f * h, i = f * i, f = f * l;
			b[0] = 1 - (j + e);
			b[4] = k - f;
			b[8] = c + i;
			b[1] = k + f;
			...
			var d = this.elements,
				e = THREE.Matrix4.__m1, f = THREE.Matrix4.__m2;
			e.identity();
			...
			var d = this.elements, e = THREE.Matrix4.__v1, f = THREE.Matrix4.__v2, h = THREE.Matrix4.__v3;
			e.set(d[0], d[1], d[2]);
			f.set(d[4], d[5], d[6]);
			h.set(d[8], d[9], d[10]);
			...
			var b = this.elements, a = a.elements, c = THREE.Matrix4.__v1, d = 1 / c.set(a[0], a[1], a[2]).length(),
				e = 1 / c.set(a[4], a[5], a[6]).length(), c = 1 / c.set(a[8], a[9], a[10]).length();
			b[0] = a[0] * d;
			b[1] = a[1] * d;
			b[2] = a[2] * d;
			b[4] = a[4] * e;
			...
			var b = this.elements, c = b[4], d = b[5], e = b[6], f = b[7], h = b[8], i = b[9], l = b[10], k = b[11],
				j = Math.cos(a), a = Math.sin(a);
			b[4] = j * c + a * h;
			b[5] = j * d + a * i;
			b[6] = j * e + a * l;
			b[7] = j * f + a * k;
			...
			var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], h = b[8], i = b[9], l = b[10], k = b[11],
				j = Math.cos(a), a = Math.sin(a);
			b[0] = j * c - a * h;
			b[1] = j * d - a * i;
			b[2] = j * e - a * l;
			...
			var b = this.elements, c = b[0], d = b[1], e = b[2], f = b[3], h = b[4], i = b[5], l = b[6], k = b[7],
				j = Math.cos(a), a = Math.sin(a);
			b[0] = j * c + a * h;
			b[1] = j * d + a * i;
			b[2] = j * e + a * l;
			...
			var d = a.x,
				e = a.y, f = a.z, h = Math.sqrt(d * d + e * e + f * f), d = d / h, e = e / h, f = f / h, h = d * d,
				i = e * e, l = f * f, k = Math.cos(b), j = Math.sin(b), m = 1 - k, n = d * e * m, o = d * f * m,
				m = e * f * m, d = d * j, s = e * j, j = f * j, f = h + (1 - h) * k, h = n + j, e = o - s, n = n - j,
				i = i + (1 - i) * k, j = m + d, o = o + s, m = m - d, l = l + (1 - l) * k, k = c[0], d = c[1], s = c[2],
				p = c[3], q = c[4], w = c[5], A = c[6], y = c[7], u = c[8], H = c[9], B = c[10], K = c[11];
			c[0] = f * k + h * q + e * u;
			c[1] = f * d + h * w + e * H;
			c[2] = f * s + h * A + e * B;
			c[3] = f * p + h * y + e * K;
		...
		makeRotationX: function (a) {
			...
			var c = Math.cos(b), d = Math.sin(b), e = 1 - c, f = a.x, h = a.y, i = a.z, l = e * f, k = e * h;
			this.set(l * f + c, l * h - d * i, l * i + d * h, 0, l * h + d * i, k * h + c, k * i - d * f, 0, l * i -
				d * h, k * i + d * f, e * i * i + c, 0, 0, 0, 0, 1);
			return this
			...
			return this.makeFrustum(e * b, a * b, e, a, c, d)
		                               ...
		                               b, c, d, e, f) {
			var h = this.elements, i = b - a, l = c - d, k = f - e;
			h[0] = 2 / i;
			h[4] = 0;
			h[8] = 0;
			h[12] = -((b + a) / i);
	...
	THREE.Projector = function () {
		...
		function c(a, b) {
			var c = 0, d = 1, g = a.z + a.w, e = b.z + b.w, f = -a.z + a.w, h = -b.z + b.w;
		...
		var d, e, f = [], h, i, l = [], k, j, m = [], n, o = [], s, p, q = [], w, A, y = [],
			u = {objects: [], sprites: [], lights: [], elements: []}, H = new THREE.Vector3, B = new THREE.Vector4,
			K = new THREE.Matrix4, N = new THREE.Matrix4, Y = new THREE.Frustum, ca = new THREE.Vector4,
			I = new THREE.Vector4;
		...
		this.projectScene = function (d, e, f) {
			var D = e.near, g = e.far, H = false, za, Da, $, R, J, Z, Q, pa, O, sa, Ga, Ha, La, Oa, Ta;
			A = p = n = j = 0;
			u.elements.length = 0;
			if (e.parent === void 0) {
					...
					for (Da = La.length; R < Da; R++) {
						...
						if ($ instanceof THREE.Face3) {
							...
							if (J.visible && Z.visible && Q.visible && pa.visible) {
								H = (pa.positionScreen.x - J.positionScreen.x) * (Z.positionScreen.y - J.positionScreen.y) - (pa.positionScreen.y - J.positionScreen.y) * (Z.positionScreen.x - J.positionScreen.x) < 0 || (Z.positionScreen.x - Q.positionScreen.x) * (pa.positionScreen.y - Q.positionScreen.y) - (Z.positionScreen.y - Q.positionScreen.y) * (pa.positionScreen.x -
									Q.positionScreen.x) < 0;
								if (O.doubleSided || H != O.flipSided) {
	...
	THREE.Quaternion.prototype = {
		constructor: THREE.Quaternion, set: function (a, b, c, d) {
			...
			var b = Math.PI / 360, c = a.x * b, d = a.y * b, e = a.z * b, a = Math.cos(d), d = Math.sin(d),
				b = Math.cos(-e), e = Math.sin(-e), f = Math.cos(c), c = Math.sin(c), h = a * b, i = d * e;
			this.w = h * f - i * c;
			this.x = h * c + i * f;
			this.y = d * b * f + a * e * c;
			this.z = a * e * f - d * b * c;
			...
			var b = this.x, c = this.y, d = this.z, e = this.w, f = a.x, h = a.y, i = a.z, a = a.w;
			...
			b || (b = a);
			var c = a.x, d = a.y, e = a.z, f = this.x, h = this.y, i = this.z, l = this.w, k = l * c + h * e - i * d,
				j = l * d + i * c - f * e, m = l * e + f * d - h * c, c = -f * c - h * d - i * e;
			b.x = k * l + c * -f + j * -i - m * -h;
			b.y = j * l + c * -h + m * -f - k * -i;
			b.z = m * l + c * -i + k * -h - j * -f;
			return b
	...
	THREE.Geometry.prototype = {
		constructor: THREE.Geometry, applyMatrix: function (a) {
			...
			var a, b, c, d, e, f, h = new THREE.Vector3, i = new THREE.Vector3;
			a = 0;
			...
			for (b = this.morphTargets.length; a < b; a++) {
				if (!this.morphNormals[a]) {
					...
					this.morphNormals[a].vertexNormals =
						[];
					var h = this.morphNormals[a].faceNormals, i = this.morphNormals[a].vertexNormals, l, k;
					c = 0;
					for (d = this.faces.length; c < d; c++) {
						e = this.faces[c];
						l = new THREE.Vector3;
			...
			var b, c, d, e, f, h, i, l, k, j, m, n, o, s, p, q, w, A, y, u, H, B, K, N, Y = [], ca = [],
				I = new THREE.Vector3, ba = new THREE.Vector3, ja = new THREE.Vector3, ya = new THREE.Vector3,
				D = new THREE.Vector3;
			b = 0;
			...
			for (c = this.faces.length; b < c; b++) {
				...
				if (f instanceof THREE.Face3) a(this, f.a, f.b, f.c, 0, 1, 2); else if (f instanceof THREE.Face4) {
			...
			if (this.vertices.length > 0) {
				...
				for (var b = this.boundingBox.min, c = this.boundingBox.max, d = 1, e = this.vertices.length; d < e; d++) {
					a = this.vertices[d];
					if (a.x < b.x) b.x = a.x; else if (a.x >
						c.x) c.x = a.x;
			...
			var a = {}, b = [], c = [], d, e = Math.pow(10, 4), f, h, i;
			f = 0;
			...
			for (h = this.faces.length; f < h; f++) {
				...
				if (e instanceof THREE.Face3) {
					...
					for (a = 3; a > 0; a--) if (d.indexOf(e["abcd"[a]]) != a) {
						...
						e = 0;
						for (d = this.faceVertexUvs.length; e <
						d; e++) (i = this.faceVertexUvs[e][f]) && i.splice(a, 1);
						break
					}
				}
			}
	...
	THREE.Spline = function (a) {
		...
		this.points = a;
		var c = [], d = {x: 0, y: 0, z: 0}, e, f, h, i, l, k, j, m, n;
		...
		this.getLength = function (a) {
			var b, c, d, e = b = b = 0, f = new THREE.Vector3, h = new THREE.Vector3, i = [], k = 0;
			i[0] = 0;
			a || (a = 100);
			...
			i[i.length] = k;
			return {chunks: i, total: k}
		};
		this.reparametrizeByArcLength = function (a) {
			var b, c, d, e, f, h, i = [], k = new THREE.Vector3, j = this.getLength();
	...
	THREE.Scene.prototype.__addObject = function (a) {
		if (a instanceof THREE.Light) this.__lights.indexOf(a) === -1 && this.__lights.push(a); else if (!(a instanceof THREE.Camera) && this.__objects.indexOf(a) === -1) {
	...
	THREE.WebGLRenderer = function (a) {
		...
		function f(a, b, c) {
			...
			h = i.length;
			var k = a.colors, j = k.length, l = a.__vertexArray, n = a.__colorArray, o = a.__sortArray,
				m = a.verticesNeedUpdate, p = a.colorsNeedUpdate, s = a.__webglCustomAttributesList;
			if (c.sortParticles) {
				Ub.copy(qb);
				...
				if (s) {
					...
					for (j = s.length; k < j; k++) {
						...
						if (i.needsUpdate && (i.boundTo === void 0 || i.boundTo === "vertices")) {
							e = i.value.length;
							f = 0;
							if (i.size === 1) for (d = 0; d < e; d++) i.array[d] = i.value[d]; else if (i.size === 2) for (d = 0; d < e; d++) {
								h = i.value[d];
								i.array[f] = h.x;
								i.array[f + 1] = h.y;
								f = f + 2
							} else if (i.size ===
								3) if (i.type === "c") for (d = 0; d < e; d++) {
								h = i.value[d];
								i.array[f] = h.r;
								i.array[f + 1] = h.g;
								i.array[f + 2] = h.b;
		...
		function o(a, b, c, d, e) {
			...
			var i = false, f = d.program, h = f.uniforms, k = d.uniforms;
			if (f !== za) {
				g.useProgram(f);
				za = f;
				i = true
			...
			if (i) {
				...
				if (d instanceof THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
					...
					D.gammaInput ? k.diffuse.value.copyGammaToLinear(d.color) :
		...
		var a = a || {}, H = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"),
			B = a.precision !== void 0 ? a.precision : "highp", K = a.alpha !== void 0 ? a.alpha : true,
			N = a.premultipliedAlpha !== void 0 ? a.premultipliedAlpha : true,
			Y = a.antialias !== void 0 ? a.antialias : false, ca = a.stencil !== void 0 ? a.stencil : true,
			...
			ja = a.clearAlpha !== void 0 ? a.clearAlpha :
				0, ya = a.maxLights !== void 0 ? a.maxLights : 4;
		this.domElement = H;
		this.context = null;
		...
		var D = this, g, Na = [], za = null, Da = null, $ = -1, R = null, J = null, Z = 0, Q = -1, pa = -1, O = -1,
			sa = -1,
			Ga = -1, Ha = -1, La = -1, Oa = -1, Ta = null, Vb = null, Wb = null, Db = null, Eb = 0, Fb = 0, Xb = 0,
			Gb = 0,
			jc = 0, kc = 0, Yb = new THREE.Frustum, qb = new THREE.Matrix4, Ub = new THREE.Matrix4,
			Ra = new THREE.Vector4,
			Ca = new THREE.Vector3, rb = true, lc = {
				ambient: [0, 0, 0],
		...
		this.renderBuffer = function (a, b, c, d, e, f) {
			if (d.visible !== false) {
				var h, i, c = o(a, b, c, d, f), b = c.attributes, a = false,
				...
				if (!d.morphTargets && b.position >= 0) {
					...
					null && g.uniform1fv(d.program.uniforms.morphTargetInfluences, f.__webglMorphTargetInfluences)
				}
				if (a) {
		...
		this.render = function (a, b, c, d) {
			var e, f, j, n, m = a.__lights, o = a.fog;
			$ = -1;
			rb = true;
			if (b.parent === void 0) {
				console.warn("DEPRECATED: Camera hasn't been added to a Scene. Adding it...");
			...
			for (e = n.length; d < e; d++) {
				...
				if (j.visible && (!(j instanceof THREE.Mesh || j instanceof THREE.ParticleSystem) || !j.frustumCulled || Yb.contains(j))) {
					s(j, b);
					var q = f, u = q.object, y = q.buffer, w = void 0, w = w = void 0, w = u.material;
					...
					f.render = true;
					if (this.sortObjects) if (j.renderDepth) f.z = j.renderDepth; else {
		...
		this.initWebGLObjects = function (a) {
			...
			for (; a.__objectsAdded.length;) {
				var h = a.__objectsAdded[0], i = a, k = void 0, l = void 0, o = void 0;
				if (!h.__webglInit) {
					h.__webglInit = true;
					...
					if (h instanceof THREE.Mesh) {
						...
						if (l instanceof THREE.Geometry) {
							if (l.geometryGroups === void 0) {
								var q = l, p = void 0, s = void 0, u = void 0, w = void 0, y = void 0, A = void 0,
									B = void 0, H = {}, K = q.morphTargets.length, Y = q.morphNormals.length;
								q.geometryGroups = {};
								p = 0;
								for (s = q.faces.length; p < s; p++) {
									...
									w = u.materialIndex;
									A = w !== void 0 ? w : -1;
									H[A] === void 0 && (H[A] = {hash: A, counter: 0});
							...
							for (k in l.geometryGroups) {
								...
								if (!o.__webglVertexBuffer) {
									...
									D.info.memory.geometries++;
									var I = o, ba = h, ja = ba.geometry, ca = I.faces3, $ = I.faces4,
										Q = ca.length * 3 + $.length * 4, za = ca.length * 1 + $.length * 2,
										pa = ca.length * 3 + $.length * 4, ya = c(ba, I), Na = e(ya), la = d(ya),
									...
									var sa = void 0, Ca = void 0;
									if (I.numMorphTargets) {
										I.__morphTargetsArrays = [];
										sa = 0;
										for (Ca = I.numMorphTargets; sa < Ca; sa++) I.__morphTargetsArrays.push(new Float32Array(Q *
											3))
									}
						...
						if (!l.__webglVertexBuffer) {
							...
							D.info.memory.geometries++;
							var Ra = l, rb = h, qb = Ra.vertices.length;
				...
				if (!h.__webglActive) {
					if (h instanceof THREE.Mesh) {
						l = h.geometry;
						if (l instanceof THREE.BufferGeometry) j(i.__webglObjects, l, h); else for (k in l.geometryGroups) {
							o = l.geometryGroups[k];
			...
			for (var Gb = 0, Yb = a.__webglObjects.length; Gb < Yb; Gb++) {
				var Va = a.__webglObjects[Gb].object, V = Va.geometry, $b = void 0, Nb = void 0, Ea = void 0;
				if (Va instanceof THREE.Mesh) if (V instanceof THREE.BufferGeometry) {
					V.verticesNeedUpdate =
						false;
					...
					for (var zc = 0, jc = V.geometryGroupsList.length; zc < jc; zc++) {
						...
						if (V.verticesNeedUpdate || V.morphTargetsNeedUpdate || V.elementsNeedUpdate || V.uvsNeedUpdate || V.normalsNeedUpdate || V.colorsNeedUpdate || V.tangetsNeedUpdate || Nb) {
							var M = $b, kc = Va, Ia = g.DYNAMIC_DRAW, lc = !V.dynamic, Hb = Ea;
							if (M.__inittedArrays) {
								var Vb = d(Hb), Ac = Hb.vertexColors ? Hb.vertexColors :
									false, Wb = e(Hb), oc = Vb === THREE.SmoothShading, v = void 0, C = void 0,
									Sa = void 0,
									z = void 0, Ob = void 0, sb = void 0, Ua = void 0, pc = void 0, lb = void 0,
									Pb = void 0, Qb = void 0, E = void 0, F = void 0, G = void 0, W = void 0,
									Wa = void 0,
									Xa = void 0, Ya = void 0, ac = void 0, Za = void 0, $a = void 0, ab = void 0,
									bc = void 0, bb = void 0, cb = void 0, db = void 0, cc = void 0, eb = void 0,
									fb = void 0, gb = void 0, dc = void 0, hb = void 0, ib = void 0, jb = void 0,
									ec = void 0, tb = void 0, ub = void 0, vb = void 0, qc = void 0, wb = void 0,
									xb = void 0, yb = void 0, rc = void 0, S = void 0, Zb = void 0, zb = void 0,
									Rb = void 0,
									Sb = void 0, ta = void 0, Ic = void 0, qa = void 0, ra = void 0, Ab = void 0,
									mb = void 0, ka = 0, oa = 0, nb = 0, ob = 0, Pa = 0, xa = 0, X = 0, Aa = 0, ma = 0,
									x = 0, L = 0, t = 0, Ja = void 0, ua = M.__vertexArray, fc = M.__uvArray,
									gc = M.__uv2Array, Qa = M.__normalArray, da = M.__tangentArray, va = M.__colorArray,
									ea = M.__skinVertexAArray, fa = M.__skinVertexBArray, ga = M.__skinIndexArray,
									ha = M.__skinWeightArray, Bc = M.__morphTargetsArrays, Cc = M.__morphNormalsArrays,
									Dc = M.__webglCustomAttributesList, r = void 0, kb = M.__faceArray,
									Ka = M.__lineArray,
									Ba = kc.geometry, yc = Ba.elementsNeedUpdate,
									Jc = Ba.uvsNeedUpdate, Nc = Ba.normalsNeedUpdate, Oc = Ba.tangetsNeedUpdate,
									Pc = Ba.colorsNeedUpdate, Qc = Ba.morphTargetsNeedUpdate, Ib = Ba.vertices,
									T = M.faces3, U = M.faces4, na = Ba.faces, Ec = Ba.faceVertexUvs[0],
									Fc = Ba.faceVertexUvs[1], Jb = Ba.skinVerticesA, Kb = Ba.skinVerticesB,
									Lb = Ba.skinIndices, Bb = Ba.skinWeights, Cb = Ba.morphTargets,
									sc = Ba.morphNormals;
					...
					if (V.verticesNeedUpdate || V.colorsNeedUpdate || Nb) {
						var pb = V, Gc = g.DYNAMIC_DRAW, hc = void 0, ic = void 0, tc = void 0, ia = void 0,
							uc = void 0,
							Kc = pb.vertices, Lc = pb.colors, Rc = Kc.length, Sc = Lc.length, vc = pb.__vertexArray,
							wc = pb.__colorArray, Tc = pb.colorsNeedUpdate, Hc = pb.__webglCustomAttributesList,
							xc = void 0, Mc = void 0, wa = void 0, Tb = void 0, Fa = void 0, aa = void 0;
						...
						if (Hc) {
							...
							for (Mc = Hc.length; xc < Mc; xc++) {
								...
								if (aa.needsUpdate && (aa.boundTo === void 0 || aa.boundTo === "vertices")) {
									ia = 0;
									Tb = aa.value.length;
									if (aa.size === 1) for (wa = 0; wa < Tb; wa++) aa.array[wa] = aa.value[wa]; else if (aa.size === 2) for (wa = 0; wa < Tb; wa++) {
										Fa = aa.value[wa];
										aa.array[ia] =
											Fa.x;
										aa.array[ia + 1] = Fa.y;
		...
		this.initMaterial = function (a, b, c, d) {
			var e, f, h;
			a instanceof THREE.MeshDepthMaterial ? h = "depth" : a instanceof THREE.MeshNormalMaterial ? h = "normal" : a instanceof THREE.MeshBasicMaterial ? h = "basic" : a instanceof THREE.MeshLambertMaterial ?
				h = "lambert" : a instanceof THREE.MeshPhongMaterial ? h = "phong" : a instanceof THREE.LineBasicMaterial ? h = "basic" : a instanceof THREE.ParticleBasicMaterial && (h = "particle_basic");
			if (h) {
			...
			a:{
				m = a.fragmentShader;
				k = a.vertexShader;
				var i = a.uniforms, b = a.attributes, c = {
					map: !!a.map,
					envMap: !!a.envMap,
					lightMap: !!a.lightMap,
				...
				s.attributes = {};
				var u,
					d = ["viewMatrix", "modelViewMatrix", "projectionMatrix", "normalMatrix", "objectMatrix", "cameraPosition", "boneGlobalMatrices", "morphTargetInfluences"];
				for (u in i) d.push(u);
				u = d;
				d = 0;
		...
		this.setFaceCulling = function (a, b) {
			if (a) {
				...
				a === "back" ? g.cullFace(g.BACK) :
					a === "front" ? g.cullFace(g.FRONT) : g.cullFace(g.FRONT_AND_BACK);
				g.enable(g.CULL_FACE)
		...
		this.setTexture = function (a, b) {
			if (a.needsUpdate) {
				...
				g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
					a.premultiplyAlpha);
				var c = a.image, d = (c.width & c.width - 1) === 0 && (c.height & c.height - 1) === 0, e = u(a.format),
					f = u(a.type);
				w(g.TEXTURE_2D, a, d);
		...
		this.setRenderTarget = function (a) {
			...
			if (a && !a.__webglFramebuffer) {
				...
				a.__webglTexture = g.createTexture();
				var c = (a.width & a.width - 1) === 0 && (a.height & a.height - 1) === 0, d = u(a.format),
					e = u(a.type);
				if (b) {
					...
					for (var f = 0; f < 6; f++) {
						...
						var h = a, i = g.TEXTURE_CUBE_MAP_POSITIVE_X + f;
	...
	THREE.GeometryUtils = {
		merge: function (a, b) {
			...
			var d, e, f, h = new THREE.Vector3, i = THREE.GeometryUtils.__v1;
			...
			if (a instanceof THREE.Face4) {
				...
				(c + h) < c ? THREE.GeometryUtils.randomPointInTriangle(d, e, b) : THREE.GeometryUtils.randomPointInTriangle(e, f, b)
			}
			...
			var d, e, f = a.faces, h = a.vertices, i = f.length, l = 0, k = [], j, m, n, o;
			for (e = 0; e < i; e++) {
				d = f[e];
			...
			for (c = a.faces.length; b < c; b++) {
				...
				if (d instanceof THREE.Face4) {
					e = d.a;
					var l = d.b, k = d.c, j = d.d, m = new THREE.Face3, n = new THREE.Face3;
					...
					e; d++) i[d].push(a.faceVertexUvs[d])
				}
			}
			a.faces = f;
			a.faceUvs = h;
			...
			for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
				...
				if (f instanceof THREE.Face4) {
					var h = f.a, i = f.b, l = f.c, h = a.vertices[h], i = a.vertices[i], l = a.vertices[l],
						k = a.vertices[f.d];
					b.push(h.clone());
					b.push(i.clone());
					b.push(l.clone());
			...
			var c, d, e, f, h, i, l, k, j, m, n, o, s, p, q, w, A, y, u, H = [], B = [];
			c = 0;
	...
	THREE.ImageUtils = {
		crossOrigin: "anonymous", loadTexture: function (a, b, c) {
			...
			for (var i = h.getImageData(0, 0, d, e).data, l = h.createImageData(d, e), k = l.data, j = 0; j < d; j++) for (var m = 0; m < e; m++) {
				var n = m - 1 < 0 ? 0 : m - 1, o = m + 1 > e - 1 ? e - 1 : m + 1, s = j - 1 < 0 ? 0 : j - 1,
					p = j + 1 > d - 1 ? d - 1 : j + 1, q = [], w = [0, 0, i[(m * d + j) * 4] / 255 * b];
				...
				s = q.length;
				for (o = 0; o < s; o++) {
					var p = q[o], A = q[(o + 1) % s], p = [p[0] - w[0], p[1] - w[1], p[2] - w[2]],
	...
	THREE.SceneUtils = {
		showHierarchy: function (a, b) {
			...
			var b;
			if (a instanceof THREE.Mesh) b = new THREE.Mesh(a.geometry, a.material); else if (a instanceof
				THREE.Line) b = new THREE.Line(a.geometry, a.material, a.type); else if (a instanceof THREE.Ribbon) b = new THREE.Ribbon(a.geometry, a.material); else if (a instanceof THREE.ParticleSystem) {
				b = new THREE.ParticleSystem(a.geometry, a.material);
				b.sortParticles = a.sortParticles
			} else if (a instanceof THREE.Particle) b = new THREE.Particle(a.material); else if (a instanceof THREE.Sprite) {
				b = new THREE.Sprite({});
	...
	THREE.WebGLRenderer && (THREE.ShaderUtils = {
		lib: {
			...
			cube: {
				uniforms: {tCube: {type: "t", value: 1, texture: null}, tFlip: {type: "f", value: -1}},
	...
	THREE.BufferGeometry.prototype = {
		constructor: THREE.BufferGeometry, computeBoundingBox: function () {
		}, computeBoundingSphere: function () {
		}
	};
	THREE.CubeGeometry = function (a, b, c, d, e, f, h, i) {
		function l(a, b, c, h, i, j, l, n) {
			var m, o = d || 1, p = e || 1, q = i / 2, g = j / 2, s = k.vertices.length;
			if (a === "x" && b === "y" || a === "y" && b === "x") m = "z"; else if (a === "x" && b === "z" || a === "z" && b === "x") {
				m = "y";
				p = f || 1
			...
			var w = o + 1, y = p + 1, A = i / o, R = j / p, J = new THREE.Vector3;
			J[m] = l > 0 ? 1 : -1;
			...
			for (i = 0; i < p; i++) for (j = 0; j < o; j++) {
				a = new THREE.Face4(j +
					w * i + s, j + w * (i + 1) + s, j + 1 + w * (i + 1) + s, j + 1 + w * i + s);
				a.normal.copy(J);
		...
		var k = this, j = a / 2, m = b / 2, n = c / 2, o, s, p, q, w, A;
		if (h !== void 0) {
			if (h instanceof Array) this.materials = h; else {
				this.materials = [];
	...
	THREE.CylinderGeometry = function (a, b, c, d, e, f) {
		THREE.Geometry.call(this);
		var a = a !== void 0 ? a : 20, b = b !== void 0 ? b : 20, c = c !== void 0 ? c : 100, h = c / 2, d = d || 8,
			e = e || 1, i, l, k = [], j = [];
		for (l = 0; l <= e; l++) {
			var m = [], n = [], o = l / e, s = o * (b - a) + a;
			for (i = 0; i <= d; i++) {
				var p = i / d, q = new THREE.Vector3;
		...
		for (i = 0; i < d; i++) {
			...
			for (l = 0; l < e; l++) {
				var o = k[l][i], s = k[l + 1][i], p = k[l + 1][i + 1], q = k[l][i + 1], w = m.clone(), A = m.clone(),
					y = n.clone(), u = n.clone(), H = j[l][i].clone(), B = j[l + 1][i].clone(),
					K = j[l + 1][i + 1].clone(),
					N = j[l][i + 1].clone();
	...
	THREE.SphereGeometry = function (a, b, c, d, e, f, h) {
		THREE.Geometry.call(this);
		var a = a || 50, d = d !== void 0 ? d : 0, e = e !== void 0 ? e : Math.PI * 2, f = f !== void 0 ? f : 0,
			h = h !== void 0 ? h : Math.PI, b = Math.max(3, Math.floor(b) || 8), c = Math.max(2, Math.floor(c) || 6), i,
			l,
			k = [], j = [];
		for (l = 0; l <= c; l++) {
			var m = [], n = [];
			for (i = 0; i <= b; i++) {
				var o = i / b, s = l / c, p = new THREE.Vector3;
		...
		for (l = 0; l < c; l++) for (i = 0; i < b; i++) {
			var d = k[l][i + 1], e = k[l][i], f = k[l + 1][i], h = k[l + 1][i + 1],
				m = this.vertices[d].clone().normalize(), n = this.vertices[e].clone().normalize(),
				o = this.vertices[f].clone().normalize(), s = this.vertices[h].clone().normalize(),
				p = j[l][i + 1].clone(),
				q = j[l][i].clone(), w = j[l + 1][i].clone(), A = j[l + 1][i + 1].clone();
