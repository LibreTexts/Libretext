...
function getCite(verbose = false) {
    ...
    // Resource Name
    let fullbook = $("meta[property='og:title']").prop('content');
    ...
    // Authors
    let authors = $("li.mt-author-information a:first").text();
    var splicedAuthors = namesplitter(authors)
    jsobj['author'] = splicedAuthors
    // Institution
    let publisher = $("li.mt-author-companyname a:first").text()
    jsobj['publisher'] = publisher
    ...
    console.log(url, title, splicedAuthors, publisher, output);
};
...
function buildcite(){
    ...
    var options ={'':'Template Selection','apa':"APA", 'harvard':"Harvard", 'vancouver':"Vancouver", 'mla':"MLA", 'chicago':"Chicago", 'acs':"ACS"}
       ...
       <div id="citeModalContent" style="cursor: pointer" >
            ...
            <div>
                <select id="citeSelect">
                    ...
                    <option value="apa">APA</option><option value="harvard1">Harvard</option>
