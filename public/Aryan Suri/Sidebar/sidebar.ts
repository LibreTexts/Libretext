...
async function Sidebar() {
	...
	function buildSidebar() {
		...
		function switchSidebar(tabs: boolean) {
			if (tabs) {
...
function activateBeeLine() {
	...
	const doBeeline = function (theme: string, action: string) {
...
class SBconverterCalculator {
	...
	UpdateUnitMenu(propMenu: { selectedIndex: any; }, unitMenu: any) {
	...
	FillMenuWithArray(myMenu: { length: any; options: { text: any; }[]; }, myArray: string | any[]) {
	...
	CalculateUnit(sourceForm: { unit_input: { value: any; }; }, targetForm: any) {
	...
	ConvertFromTo(sourceForm: { unit_menu: { selectedIndex: any; }; unit_input: { value: any; }; }, targetForm: { unit_menu: { selectedIndex: any; }; unit_input: { value: number; }; }) {
