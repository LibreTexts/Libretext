...
(function(a, b) {
  ...
  function bq(a) {
    ...
    b === "input"
      ? bp(a)
      : b !== "script" && typeof a.getElementsByTagName != "undefined" && f.grep(a.getElementsByTagName("input"), bp)
  }
  function bp(a) {
        ...
        for (c in i)
          for (d = 0, e = i[c].length; d < e; d++)
            f.event.add(b, c + (
              i[c][d].namespace
              ? "."
              : "") + i[c][d].namespace, i[c][d], i[c][d].data)
        }
  ...
  f.extend({
    ...
    when: function(a) {
      ...
      var b = i.call(arguments, 0),
        ...
        g = d,
        h = d,
        j = d <= 1 && a && f.isFunction(a.promise)
          ? a
          : f.Deferred(),
        k = j.promise();
      if (d > 1) {
    ...
    data: function(a, c, d, e) {
      if (!!f.acceptData(a)) {
        var g,
          ...
          n = l
            ? a[f.expando]
            : a[f.expando] && f.expando,
          o = c === "events";
        if ((!n || !m[n] || !o && !e && !m[n].data) && k && d === b)
          return;
        n || (
          l
          ? a[f.expando] = n = ++f.uuid
          : n = f.expando),
  ...
  f.extend({
        ...
        get: function(a) {
          ...
          for (; c < d; c++) {
            ...
            if (e.selected && (
              ...
              ? !e.disabled
              : e.getAttribute("disabled") === null) && (!e.parentNode.disabled || !f.nodeName(e.parentNode, "optgroup"))) {
              b = f(e).val();
              if (j)
                return b;
              h.push(b)
    ...
    attr: function(a, c, d, e) {
      ...
      if (!("getAttribute" in a))
        return f.prop(a, c, d);
      i = j !== 1 || !f.isXMLDoc(a),
      i && (c = c.toLowerCase(), h = f.attrHooks[c] || (
        u.test(c)
        ? x
        : w));
      if (d !== b) {
  ...
  f.event = {
    ...
    remove: function(a, b, c, d) {
      ...
      if (!!e && !!(m = e.events)) {
        ...
        f.isEmptyObject(m) && (o = e.handle, o && (o.elem = null), f.removeData(a, [
          "events", "handle"
        ], !0))
      }
    },
  ...
  f.support.submitBubbles || (f.event.special.submit = {
    setup: function() {
      ...
      f.event.add(this, "click._submit keypress._submit", function(a) {
        var c = a.target,
          d = f.nodeName(c, "input") || f.nodeName(c, "button")
            ? c.form
            : b;
  ...
  function() {
    ...
    var m = function(b, d, e, f) {
      ...
      if (w.length > 1 && p.exec(b))
        ...
        !f && w.length > 1 && d.nodeType === 9 && !v && o.match.ID.test(w[0]) && !o.match.ID.test(w[w.length - 1]) && (
          n = m.find(w.shift(), d, v), d = n.expr
          ? m.filter(n.expr, n.set)[0]
          : n.set[0]);
        if (d) {
          n = f
            ? {
            ...
            : m.find(
              w.pop(), w.length === 1 && (w[0] === "~" || w[0] === "+") && d.parentNode
              ? d.parentNode
              : d,
            v),
          j = n.expr
            ? m.filter(n.expr, n.set)
            : n.set,
          w.length > 0
            ? k = s(j)
            : u = !1;
    ...
    m.find = function(a, b, c) {
      ...
      d || (
        d = typeof b.getElementsByTagName != "undefined"
    ...
    var n = m.getText = function(a) {
      ...
      o = m.selectors = {
          ...
          "+": function(a, b) {
            ...
            for (var f = 0, g = a.length, h; f < g; f++)
              if (h = a[f]) {
                ...
                ;
                a[f] = e || h && h.nodeName.toLowerCase() === b
                  ? h || !1
                  : h === b
              }
            e && m.filter(b, a, !0)
        ...
        filter: {
          ...
          CLASS: function(a, b) {
            return (" " + (
            a.className || a.getAttribute("class")) + " ").indexOf(b) > -1
          },
          ATTR: function(a, b) {
            var c = b[1],
              d = m.attr
  ...
  f.fn.extend({
    ...
    closest: function(a, b) {
      ...
      var i = T.test(a) || typeof a != "string"
        ? f(a, b || this.context)
        : 0;
      for (d = 0, e = this.length; d < e; d++) {
        g = this[d];
  ...
  c.documentElement.currentStyle && (bD = function(a, b) {
    ...
    f === null && g && (e = g[b]) && (f = e),
    !bv.test(f) && bw.test(f) && (
      c = g.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), g.left = b === "fontSize"
      ? "1em"
      : f || 0,
    f = g.pixelLeft + "px",
    g.left = c,
      ...
      f.ajax({
        ...
        complete: function(a, b, c) {
          ...
          a.isResolved() && (a.done(function(a) {
            ...
            g
            ? f("<div>").append(c.replace(bP, "")).find(g)
            : c)),
          d && i.each(d, [c, b, a])
        }
      });
  ...
  f.extend({
    ...
    ajax: function(a, c) {
      ...
      d.crossDomain == null && (r = bT.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bY[1] && r[2] == bY[2] && (r[3] || (
        r[1] === "http:"
        ? 80
        : 443)) == (bY[3] || (
        bY[1] === "http:"
  ...
  f.ajaxPrefilter("json jsonp", function(b, c, d) {
    ...
    if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (cg.test(b.url) || e && cg.test(b.data))) {
      var g,
        ...
        k = b.data,
        l = "$1" + h + "$2";
      b.jsonp !== !1 && (j = j.replace(cg, l), b.url === j && (e && (k = k.replace(cg, l)), b.data === k && (j += (
        /\?/.test(j)
        ? "&"
        : "?") + b.jsonp + "=" + h))),
      b.url = j,
          ...
          cp.test(h)
            ? (
              o = f._data(this, "toggle" + i) || (
                ...
                : 0), o
              ? (f._data(
                this, "toggle" + i, o === "show"
                ? "hide"
                : "show"), j[o]())
              : j[h]())
            : (
              k = cq.exec(h), l = j.cur(), k
              ? (m = parseFloat(k[2]), n = k[3] || (
                f.cssNumber[i]
                ? ""
                : "px"), n !== "px" && (f.style(this, i, (m || 1) + n), l = (m || 1) / j.cur() * l, f.style(this, i, l + n)), k[1] && (m = (
                k[1] === "-="
                ? -1
                : 1) * m + l), j.custom(l, m, n))
              : j.custom(l, h, ""));
        return !0
      }
      var e = f.speed(b, c, d);
