const key = "f4235c68fadeaf4f261da54ab575d82c26041c2543320b5e0874465d0f279536"; //browser key
...
fetch("https://computer.miniland1333.com/getKey").then(async (response) => {
	...
	console.log(key);
	const headers = {'X-Deki-Token': key};
	//true ? {headers: {"Authorization": `Basic ${btoa("Hank:10/12meeting")}`}}
	fetch(url, {headers: headers}).then(handleResponse);
});
