...
a._getZ(b,"coverImage")+';" />';d=a._appletCssText.replace(/\'/g,'"');var h=b._getSpinner&&b._getSpinner();b._spinner=h=!h||"none"==h?"":"background-image:url("+h+"); background-repeat:no-repeat; background-position:center;";d=h+(0<=d.indexOf('style="')?d.split('style="')[1]:'" '+d);d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;margin:auto;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:'+a._getZ(b,"header")+";width:100%;height:100%;position:absolute;top:0px;left:0px;"+
...
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var m=!1,l=[],h=[],e=0,j=[],t=[],s=function(b){arguments.length||(b=!0);delete e;for(var d;0<h.length&&"done"==(d=h[0])[4];)h.shift();if(0!=h.length)if(!a._isAsync&&!b)setTimeout(s,10);else{d.push("done");var j="JSmol exec "+d[0]._id+" "+d[3]+" "+d[2];self.console&&console.log(j+" -- OK");l.push(j);d[1](d[0],d[2])}},u=function(b){m?s():(m=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
...
function(a){C.consoleOutput(a,"red")};ba.err.println=function(a){C.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};ba.err.write=function(a,b,c){ba.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2018-02-03 09:25:42 -0600 (Sat, 03 Feb 2018) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.29.3";
