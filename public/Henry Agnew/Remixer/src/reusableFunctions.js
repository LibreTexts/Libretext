let RemixerFunctions = {
	...
	autoGeneratedPages: ['01:_TitlePage', '02:_InfoPage', '03:_Table_of_Contents', '10:_Index', '20:_Glossary']
};
...
function generateDefault(chapters, pages) {
	...
	function autogenerateMatter(strings) {
		return strings.map(item => {
			let [index, title] = item.split('%3A_');
			return {
				expanded: true,
				key: item,
				lazy: false,
				title: decodeURIComponent(item),
				data: {id: index, status: 'autoGenerated', "padded": item, autoGenerated: true},
				children: []
			}
		})
	}
	...
	children.push({
		...
		lazy: false,
		title: `Front Matter`,
		data: {id: -1, status: 'new', "padded": `00%3A_Front Matter`, articleType:'topic-guide'},
		children: autogenerateMatter(['01%3A_TitlePage', '02%3A_InfoPage', '03%3A_Table_of_Contents'])
	})
	...
	children.push({
		...
		lazy: false,
		title: `Back Matter`,
		data: {id: -1, status: 'new', "padded": `zz:_Back_Matter`, articleType:'topic-guide'},
		children: autogenerateMatter(['10%3A_Index', '20%3A_Glossary'])
	})
